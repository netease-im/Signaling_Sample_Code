...
/** @fn void nim_team_query_members_invitor(const char *tid, const char *members, const char *json_extension, nim_team_query_members_invitor_cb_func cb,const void *user_data);
* 查询群成员的邀请人 accid
* @param[in] tid		群组id
